        ...
        <div className="bg-white shadow-md rounded-lg overflow-x-auto">
          <table className="w-full text-sm text-left text-gray-600">
            <thead className="bg-blue-50 text-gray-700 uppercase">
              <tr>
                <th onClick={() => handleSort('image')} className="cursor-pointer px-6 py-2">Image</th>
                <th onClick={() => handleSort('title')} className="cursor-pointer px-6 py-2">Title</th>
                <th onClick={() => handleSort('status')} className="cursor-pointer px-6 py-2 text-center">Status</th>
                <th className="px-6 py-2 text-center">Actions</th>
                <th className="px-6 py-2 text-center">Link</th>
              </tr>
            </thead>
            ...
            <tbody>
              {currentBlogs.map((blog) => (
                ...
                >
                  <td className="px-6 py-1 border-b border-gray-200">
                    <Image
                      className="w-28 h-16 object-cover border rounded-lg"
