...
//                 savedArrangement.map((product) => ({
//                     id: product.id,
//                     content: product.nickname || "Unnamed",
//                     status: product.status,
//                     seo: product.seo,
//                 }))
//             );
...
//         let sourceList = [...availableProducts];
//         let destinationList = [...selectedProducts];
...
//         if (result.source.droppableId === "available") {
//             setAvailableProducts(sourceList);
//             setSelectedProducts([...destinationList, movedItem]); // Add at the end
//         } else {
//             setSelectedProducts(sourceList);
//             setAvailableProducts([...destinationList, movedItem]); // Add at the end
//         }
//     };
...
//                 <div className="flex space-x-4">
//                     {/* Available Products */}
//                     <ProductList title="Available Products" listId="available" products={availableProducts} />

//                     {/* Selected Products */}
//                     <ProductList title="Selected Products" listId="selected" products={selectedProducts} />
//                 </div>
//             </DragDropContext>
//             <button
//                 onClick={handleSubmit}
...
// const ProductList = ({ title, listId, products }) => (
//     <div className="w-1/2 bg-gray-100 p-4 rounded-lg shadow-md">
...
//                                     {...provided.draggableProps}
//                                     {...provided.dragHandleProps}
//                                     className={`p-3 rounded-md mb-2 shadow cursor-grab bg-blue-500 text-white`}
//                                     style={{ ...provided.draggableProps.style }}
//                                 >
//                                     {task.content}
//                                 </div>
