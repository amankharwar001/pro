...
//       const result = await response.json();
//       console.log("result show is here section7",result)
//       if (result.success) {
//         setMessage(result.message);
//         setIsEditMode(true);
//         setActiveBox(8);
  ...
  return (
    <div className="p-4">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          <label htmlFor="content" className="block font-bold text-gray-700">Content</label>
          <ReactQuill value={content} onChange={setContent} className="border p-2 w-full rounded-md" />
        </div>
        <div>
          <label htmlFor="btn" className="block font-bold text-gray-700">Button Text</label>
        ...
        <div>
          <label htmlFor="btnLink" className="block font-bold text-gray-700">Button Link</label>
          <input type="url" id="btnLink" value={btnLink} onChange={(e) => setBtnLink(e.target.value)} className="border p-2 w-full rounded-md" />
        </div>
