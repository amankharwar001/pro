...
//       {item.key === "logout" ? (
//         <div
//           className="px-6 py-2 text-sm hover:bg-gray-700 rounded-lg cursor-pointer flex items-center gap-4"
...
//         <>
//           <div
//             className={`px-6 py-2 text-sm hover:bg-gray-700 rounded-lg cursor-pointer flex items-center justify-between transition-all duration-300 ${item.subMenus ? "hover:pl-8" : "hover:pl-7"
//               }`}
//             onClick={() => item.subMenus && toggleMenu(item.key)}
//           >
//             <Link
//               onClick={() => !item.subMenus && handleMenuItemClick()}
//               href={item.link || "#"}
