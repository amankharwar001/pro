...
// const HeroSections = ({info,heading,para,img}) => {
        ...
        <div className="relative bg-zinc-100 my-5 rounded-2xl h-3/4 overflow-hidden">
          ...
          <div className="absolute z-10 top-20 md:top-1/4  flex md:max-w-2xl flex-col md:pl-20 md:items-start text-white px-7">
            ...
            >
              ...
              {/* <button className="flex bg-[#003066] text-white text-base md:text-lg justify-start md:justify-center p-2 md:p-4 px-4 md:px-6 rounded-full mt-6">
                {heroSection.btn}
              </button> */}
            </motion.div>
          </div>
