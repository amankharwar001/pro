      ...
      <div className="m-auto p-4 mb-10 bg-white rounded-lg border shadow-md mt-10">
        ...
        <form className="grid grid-cols-1 sm:grid-cols-2 gap-6" onSubmit={handleSubmit}>
          ...
          <div className="flex items-start space-x-2 sm:col-span-2">
            ...
            />
            <label htmlFor="consent" className="text-sm text-gray-600">
              I authorize Paramotor Digital Technology Private Limited and its representatives to contact me by
              telephone, email, or SMS with reference to my enquiry/application. This consent will override any
              registration for DND/DNC/NDNC.*
            </label>
          </div>
