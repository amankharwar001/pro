        ...
        <div className='pt-20'>
            ...
            <div className="container m-auto  relative -mb-44">
                <div className="grid md:grid-cols-2 z-10 gap-10" ref={ref}>
                    ...
                    {/* right 3 images */}
                    <div className="md:flex gap-3 lg:gap-5 flex-wrap md:flex-nowrap md:pr-5">
                        <div className="grow max-w-[351px] m-auto md:m-0 md:min-w-[25vw] lg:min-w-[20vw] xl:min-w-[320px]">
                            <motion.div
                        ...
                        <div className="w-full py-8 relative">
                            <div className="mb-20 md:mb-0 max-w-[351px] m-auto md:w-full bg-slate-200 rounded-xl">
                                <motion.div
