                        ...
                        <div>
                            ...
                            <div className="flex md:justify-start justify-center pb-10  text-white items-center bg-background px-6">
                                <div className="text-center mr-8">
                                    <div className="text-h2_large font-bold text-red-600">{apidata2?.leadDetails[0].leadNo}</div>
                                ...
                                <div className="text-center ml-8">
                                    <div className="text-h2_large font-bold text-red-600">{apidata2?.leadDetails[1].leadNo}</div>
