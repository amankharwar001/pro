      ...
      <div className="text-center p-8 bg-background mt-10">
        <div>
          ...
          <Fade triggerOnce direction="down" delay={200}>
            <p className="text-muted-foreground mb-8">{content || 'What our users say about us'}</p>
          </Fade>
        </div>
        <Zoom triggerOnce>
        ...
        <div className="relative mb-8">
          <Slide direction="up" triggerOnce>
            <blockquote className="bg-card p-10 rounded-lg shadow-lg max-w-md m-auto border">
