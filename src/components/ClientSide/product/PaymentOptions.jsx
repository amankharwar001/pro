...
//   const svg1 = section5.Images.find((image) => image.referenceId === 51);
//   const svg2 = section5.Images.find((image) => image.referenceId === 52);
//   const svg3 = section5.Images.find((image) => image.referenceId === 53);
...
//               const icon = [svg1, svg2, svg3][index]; // Dynamically get correct image
//               return (
