...
//     );
//     console.log("section 4 data show is here",section4)
//     return (
...
//                         <div
//                             key={index}
//                             className={`flex flex-col lg:flex-row items-center gap-10 ${isTextLeft ? "lg:flex-row" : "lg:flex-row-reverse"
//                                 }`}
//                         >
//                             {/* Left Side - Text */}
//                             <div className="flex-1 text-center lg:text-left z-10">
...
//                             <div className="flex-shrink-0 w-full lg:w-1/2 flex justify-center relative">
//                                 {/* Background Circle */}
//                                 agar left me show kr rahi ha to ye show kare
//                                 <div className="absolute top-1/2 -translate-y-2/4 lg:right-0 lg:top-2/4 lg:-translate-y-2/4 flex justify-center items-center">
//                                     <div className="w-[150px] h-[150px] sm:w-[250px] sm:h-[250px] md:w-[320px] md:h-[320px] lg:w-[400px] lg:h-[400px] bg-gradient-to-r from-[#fff2d7] to-[#f8d9d5] opacity-50 custom-border-radius-2"></div>
//                                 </div>
//                                 agar right me image show ho rahi ha to ye show kare 
