...
const HeroSectionPatnerPage = sequelize.define('HeroSectionPatnerPage', {
  title: {
  ...
  tableName: 'hero_section_partner_page',  // Ensure this matches your table name exactly
  timestamps: true,
});


export default HeroSectionPatnerPage;
