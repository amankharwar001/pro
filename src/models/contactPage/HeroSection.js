...
const heroSectionContactPage = sequelize.define('HeroSectionContactPage', {
  title: {
  ...
  tableName: 'hero_section_contact_page',  // Ensure this matches your table name exactly
  timestamps: true,
});


export default heroSectionContactPage;
