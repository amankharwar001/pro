...
const homepagePublic = async (req, res) => {
    ...
    try {
        ...
        const section6Images = isSectionActive('homepage_section6') ? await fetchDataSafely(() => ImagesData.findAll({ where: { referenceType: ['homepage_section1', 'homepage_section2', 'homepage_section3','homepage_section4','homepage_section5','homepage_section6','homepage_section7','homepage_section8','homepage_section9','homepage_section10','homepage_section11','homepage_section12','homepage_section13','homepage_section14','homepage_section15','homepage_section16','homepage_section17','homepage_section18','homepage_section19','homepage_section20'] } }), []) : [];
        ...
        const section8Images = isSectionActive('homepage_section8') ? await fetchDataSafely(() => ImagesData.findAll({ where: { referenceType: ['homepage_section_8_primary', 'homepage_section_8'] } }), []) : [];
