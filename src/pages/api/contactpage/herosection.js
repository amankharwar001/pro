    ...
    if (method === 'POST') {
      ...
      try {
        ...
        if (id) {
          ...
          heroSection = await heroSectionContactPage.findById(id);
          ...
          const existingHeroSection = await heroSectionContactPage.findOne();
          ...
          if (existingHeroSection) {
            ...
            // Create new record
            heroSection = await heroSectionContactPage.create({
              title,
              heading,
              text,
              btn,
      ...
      const heroSection = await heroSectionContactPage.findOne();
