...
//         <div className={`${visible?"hidden":"flex"} items-center justify-between bg-slate-100 sticky top-[68.2px] z-[100] px-2 py-2 mb-5 shadow-lg  border-b-2 border-red-800`}>
//           <div>
//             <h2 className="text-2xl font-semibold text-gray-700 ">Edit Blog</h2>
//             {/* <span className="absolute -left-2" onclick={vissibleHandle}>button</span> */}
...
//           </div>
//         </div>
//         <FaEye className="sticky top-[68.2px] z-[101] cursor-pointer" size={100} onclick={vissibleHandle}/> 
